	...
	if (url == '/venuefinder.db') {
		...
		if (cleanDB == true) {
			...
			// Remove Files Once Done
					...
					var zipToDelete = Titanium.Filesystem.getFile(Titanium.Filesystem.tempDirectory, '/' + url + '.zip');
					var dbToDelete = Titanium.Filesystem.getFile(Titanium.Filesystem.tempDirectory, '/' + url + '.db');
