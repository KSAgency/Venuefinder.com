...
var s_account="cmpivenuefinderappdev"
...
/* External Campaigns: places campaigns in order thats specified below */
    ...
    s.campaign=s.getValOnce(s.getQueryParam('cid,kw,utm_campaign,utm_medium,utm_source,utm_content'),'ext_campaign',30);

// Internal Campaigns: 
    //s.eVar2=s.getValOnce(s.getQueryParam('icid'),'int_campaign',30);
    
//Get previous page value
    s.prop14=s.getPreviousValue(s.pageName,'gpv_pn','event12');
    s.eVar14=s.prop14;  
...
// getTimeParting without year check
    s.prop10=s.eVar10=s.getTimeParting('h','0'); // Set hour 
    s.prop11=s.eVar11=s.getTimeParting('d','0'); // Set day 
    s.prop12=s.eVar12=s.getTimeParting('w','0'); // Set weekday
...
/* Percent Page Viewed */
    s.prop15 = s.getPercentPageViewed();    
...
// copy s.props to eVars
    ...
    if(s.eVar16 && s.eVar16!=""){
        s.eVar16=s.eVar16.toLowerCase();
        s.prop18=s.eVar16;
    }
    if(s.eVar33 && s.eVar33!=""){
        s.eVar33=s.eVar33.toLowerCase();
        s.prop26=s.eVar33;
    }
    if(s.eVar26 && s.eVar26!=""){
        s.eVar26=s.eVar26.toLowerCase();
        s.prop27=s.eVar26;
    }
    if(s.eVar27 && s.eVar27!=""){
        s.eVar27=s.eVar27.toLowerCase();
        s.prop28=s.eVar27;
    }
    if(s.eVar28 && s.eVar28!=""){
        s.eVar28=s.eVar28.toLowerCase();
        s.prop29=s.eVar28;
    }
    if(s.eVar39 && s.eVar39!=""){
        s.eVar39=s.eVar39.toLowerCase();
        s.prop34=s.eVar39;
    }
    if(s.eVar40 && s.eVar40!=""){
        s.eVar40=s.eVar40.toLowerCase();
        s.prop35=s.eVar40;
    }
    if(s.eVar41 && s.eVar41!=""){
    ...
    if(s.eVar62 && s.eVar62!=""){
        s.eVar62=s.eVar62.toLowerCase();
        s.prop62=s.eVar62;
    }
    if(s.eVar63 && s.eVar63!=""){
        s.eVar63=s.eVar63.toLowerCase();
        s.prop63=s.eVar63;
    }
    if(s.eVar64 && s.eVar64!=""){
        s.eVar64=s.eVar64.toLowerCase();
        s.prop64=s.eVar64;
    }
    if(s.eVar65 && s.eVar65!=""){
        s.eVar65=s.eVar65.toLowerCase();
        s.prop65=s.eVar65;
    }
    if(s.prop70 && s.prop70!=""){
        s.prop70=s.prop70.toLowerCase();
        s.eVar70=s.prop70;
    }
    if(s.prop71 && s.prop71!=""){
        s.prop71=s.prop71.toLowerCase();
        s.eVar71=s.prop71;
    }
    if(s.prop72 && s.prop72!=""){
        s.prop72=s.prop72.toLowerCase();
        s.eVar72=s.prop72;
    }
    if(s.prop73 && s.prop73!=""){
        s.prop73=s.prop73.toLowerCase();
        s.eVar73=s.prop73;
    }
    if(s.hier2 && s.hier2!=""){
        s.hier2=s.hier2.toLowerCase();
    }   
}
