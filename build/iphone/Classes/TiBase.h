...
// in simulator we redefine to format for VenueFinder Developer console
...
{\
	NSString * exceptionName = [@"org.venuefinder." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.venuefinder";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVenueFinderNativeItemNone = -1, 
	UIVenueFinderNativeItemSpinner = -2,
	UIVenueFinderNativeItemProgressBar = -3,
	
	UIVenueFinderNativeItemSlider = -4,
	UIVenueFinderNativeItemSwitch = -5,
	UIVenueFinderNativeItemMultiButton = -6,
	UIVenueFinderNativeItemSegmented = -7,
	
	UIVenueFinderNativeItemTextView = -8,
	UIVenueFinderNativeItemTextField = -9,
	UIVenueFinderNativeItemSearchBar = -10,
	
	UIVenueFinderNativeItemPicker = -11,
	UIVenueFinderNativeItemDatePicker = -12,
	
	UIVenueFinderNativeItemInfoLight = -13,
	UIVenueFinderNativeItemInfoDark = -14,
	
	UIVenueFinderNativeItemDisclosure = -15,
	
	UIVenueFinderNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VenueFinder instances of
