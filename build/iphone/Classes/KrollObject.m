...
//@interface VenueFinderObject : NSObject
//@end

@interface VenueFinderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VenueFinderObject class]])
		{
			for (NSString *key in [[(VenueFinderObject*)o modules] allKeys])
			{
