...
/**
 Base class for all VenueFinder views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the VenueFinder view hierarchy (such as wrapped iOS UIViews) was touched.
