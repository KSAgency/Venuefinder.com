...
@interface VenueFinderObject : KrollCoverageObject {
#else
@interface VenueFinderObject : KrollObject {
#endif
@private
...
extern NSString * VenueFinder$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	VenueFinderObject *_venuefinder;
    KrollObject* console;
	BOOL shutdown;
