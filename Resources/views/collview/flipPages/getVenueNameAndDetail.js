...
function getVenueText(venueID) {
	...
	var boldText;
	var signatureText = '</br></br>Best</br>Toni Walsh</br>Content Manager</br>Venuefinder.com</br><a href="mailto:toni.walsh@ubm.com">toni.walsh@ubm.com</a>';
	if (venueID == 39) {
		//image = '/images/collection-cover.png';
		...
		venueText = '<span style="font-family:' + Ti.App.Properties.getString('fontFamily') + '; color:#000; font-size:14px; line-height:20pts; font-size:15px;">'+boldText+para1+para2+para3+para4+signatureText+'</span>';
	} else if (venueID == 15) {
		...
		venueText = '<span style="font-family:' + Ti.App.Properties.getString('fontFamily') + '; color:#000; font-size:14px; line-height:20pts; font-size:15px;">'+boldText+para1+para2+para3+para4+para5+signatureText+'</span>';
	} else if (venueID == 3) {
		...
		venueText = '<span style="font-family:' + Ti.App.Properties.getString('fontFamily') + '; color:#000; font-size:14px; line-height:20pts; font-size:15px;">'+boldText+para1+para2+para3+para4+para5+para6+signatureText+'</span>';
	} else if (venueID == 19) {
