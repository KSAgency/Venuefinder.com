		...
		var xhr = Titanium.Network.createHTTPClient({
			...
			onload:function() {
				...
				if (result == 'success') {
					...
					var zipToDelete = Titanium.Filesystem.getFile(Titanium.Filesystem.tempDirectory, '/' + fileName + '.zip');
					var dbToDelete = Titanium.Filesystem.getFile(Titanium.Filesystem.tempDirectory, '/' + fileName + '.db');

					zipToDelete.deleteFile();
					dbToDelete.deleteFile();
