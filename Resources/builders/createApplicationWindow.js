function createApplicationWindow(tabGroup, view, name, backgroundColor, tab, tier1, tier2, tier3, venueID, tabSelect){
    ...
    var omniture = Titanium.UI.createWebView({
        html:'<html><head><script type="text/javascript" src="s_code.js"></script></head><body><script>' + 
        's.channel="'+Ti.App.Properties.getString('osname')+'";' +
        's.pageName="'+tab+'";' + 
        's.prop1="'+tier1+'";' +
        's.prop2="'+tier2+'";' + 
        's.prop3="'+tier3+'";' + 
        's.events="event4";' + 
        'var s_code=s.t(); if(s_code)document.write(s_code)</script><script>if(navigator.appVersion.indexOf("MSIE")>=0)document.write(unescape("%3C")+"\!-"+"-")</script><noscript><img src="https://cmpi.122.2o7.net/b/ss/cmpivenuefinderappprod/1/H.25.2--NS/0?[AQB]&cdp=3&[AQE]"height="1" width="1" border="0" alt="" /></noscript></body></html>',
        opacity:0,
        width:0,
        height:0,
        left:0,
